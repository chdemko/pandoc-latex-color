# pandoc-latex-color
[![Build Status](https://img.shields.io/travis/chdemko/pandoc-latex-color/0.1.0.svg)](https://travis-ci.org/chdemko/pandoc-latex-color/branches)
[![Coveralls](https://img.shields.io/coveralls/github/chdemko/pandoc-latex-color/0.1.0.svg)](https://coveralls.io/github/chdemko/pandoc-latex-color?branch=0.1.0)
...
[![License](https://img.shields.io/pypi/l/pandoc-latex-color/0.1.0.svg)](https://raw.githubusercontent.com/chdemko/pandoc-latex-color/0.1.0/LICENSE)
[![Python version](https://img.shields.io/pypi/pyversions/pandoc-latex-color/0.1.0.svg)](https://pypi.org/project/pandoc-latex-color/0.1.0/)
[![Development Status](https://img.shields.io/pypi/status/pandoc-latex-color/0.1.0.svg)](https://pypi.org/project/pandoc-latex-color/0.1.0/)
